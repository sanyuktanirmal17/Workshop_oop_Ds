...
public class DeckOfCards {
	...
	private String[] rank = new String[] { "2", "3", "4", "5", "6", "7", "8", "9", "10", "Jack", "Queen", "King",
			"Ace" };
	String[] card = new String[52];
	int start = 0, end = 12, j1 = 0;

	/**
	 * for combination of Suits and Ranks. Created HashSet to check if all cards are
	 * unique.
	 * 
	...
	private String[] Deck() {
		...
		/**
		 * printing cards for 4 player distributed is done to receive all 9 cards for
		 * each
		 */
